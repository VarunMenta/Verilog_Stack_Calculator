...
#set_property PACKAGE_PIN V2 [get_ports {presets[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {presets[6]}]
#set_property PACKAGE_PIN T3 [get_ports {presets[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {presets[7]}]
